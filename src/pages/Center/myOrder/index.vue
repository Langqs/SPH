          ...
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="item in myOrder.records" :key="item.id">
                ...
                <tbody>
                  <tr v-for="(itemMin,index) in item.orderDetailList" :key="itemMin.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="itemMin.imgUrl" style="width:80px;heigth:80px">
                        <a href="#" class="block-text">{{itemMin.skuName}}</a>
                        <span>x{{itemMin.skuNum}}</span>
